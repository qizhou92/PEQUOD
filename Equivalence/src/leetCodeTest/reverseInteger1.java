...
public class reverseInteger1 {
	...
	public static void main(String[] args) throws IOException {
		...
		ExceptionalUnitGraph cfgLeft=new ExceptionalUnitGraph(stores.get("<toy_benchmark.reverseInteger: int reverse1(int)>"));
		ExceptionalUnitGraph cfgRight=new ExceptionalUnitGraph(stores.get("<toy_benchmark.reverseInteger: int reverse2(int)>"));
		PairDAG theSolver=new PairDAG(cfgLeft,cfgRight,"test");
		InterpolationContext ictx=theSolver.getIctx();
		BoolExpr extraPolicy=ictx.mkGe(ictx.mkIntConst("i2Path0Copy1Level0index0"), ictx.mkInt("0"));
