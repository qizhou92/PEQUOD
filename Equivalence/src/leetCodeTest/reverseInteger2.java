...
public class reverseInteger2 {
	...
	public static void main(String[] args) throws IOException {
		...
		ExceptionalUnitGraph cfgLeft=new ExceptionalUnitGraph(stores.get("<toy_benchmark.reverseInteger: int reverse3(int)>"));
		ExceptionalUnitGraph cfgRight=new ExceptionalUnitGraph(stores.get("<toy_benchmark.reverseInteger: int reverse1(int)>"));
		PairDAG theSolver=new PairDAG(cfgLeft,cfgRight,"test");
		InterpolationContext ictx=theSolver.getIctx();
		BoolExpr extraPolicy=ictx.mkGe(ictx.mkIntConst("i2Path1Copy2Level0index0"), ictx.mkInt("0"));
