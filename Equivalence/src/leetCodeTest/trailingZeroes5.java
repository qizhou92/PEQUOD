...
public class trailingZeroes5 {
	...
	public static void main(String[] args) throws IOException {
		...
		ExceptionalUnitGraph cfgLeft=new ExceptionalUnitGraph(stores.get("<toy_benchmark.trailingZeroes: int trailingZeroes4(int)>"));
		ExceptionalUnitGraph cfgRight=new ExceptionalUnitGraph(stores.get("<toy_benchmark.trailingZeroes: int trailingZeroes3(int)>"));
		PairDAG theSolver=new PairDAG(cfgLeft,cfgRight,"test");
		InterpolationContext ictx=theSolver.getIctx();
		BoolExpr extraPolicy=ictx.mkGe(ictx.mkIntConst("i0Path0Copy1Level0index0"), ictx.mkInt(5));
