...
public class trailingZeroes2 {
	...
	public static void main(String[] args) throws IOException {
		...
		ExceptionalUnitGraph cfgLeft=new ExceptionalUnitGraph(stores.get("<toy_benchmark.trailingZeroes: int trailingZeroes2(int)>"));
		ExceptionalUnitGraph cfgRight=new ExceptionalUnitGraph(stores.get("<toy_benchmark.trailingZeroes: int trailingZeroes1(int)>"));
		PairDAG theSolver=new PairDAG(cfgLeft,cfgRight,"test");
		InterpolationContext ictx=theSolver.getIctx();
		BoolExpr extraPolicy=ictx.mkGe(ictx.mkIntConst("i0Path1Copy2Level0index0"), ictx.mkInt(5));
