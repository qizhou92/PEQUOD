...
public class scoreIncreasing {
	...
	public static void main(String[] args) throws IOException {
		...
		ExceptionalUnitGraph cfgLeft=new ExceptionalUnitGraph(stores.get("<toy_benchmark.scoreIncreasing: boolean scoresIncreasing1(int[])>"));
		ExceptionalUnitGraph cfgRight=new ExceptionalUnitGraph(stores.get("<toy_benchmark.scoreIncreasing: boolean scoresIncreasing2(int[])>"));
