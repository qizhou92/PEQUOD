...
public class test7 {
	...
	public static void main(String[] args) throws IOException {
		...
		ExceptionalUnitGraph cfgLeft=new ExceptionalUnitGraph(stores.get("<toy_benchmark.Test7: int main(int)>"));
		ExceptionalUnitGraph cfgRight=new ExceptionalUnitGraph(stores.get("<toy_benchmark.Test7: int main2(int)>"));
