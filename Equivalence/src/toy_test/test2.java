...
public class test2 {
	...
	public static void main(String[] args) throws IOException {
		...
		ExceptionalUnitGraph cfgLeft=new ExceptionalUnitGraph(stores.remove("<toy_benchmark.Test2: int main(int)>"));
		ExceptionalUnitGraph cfgRight=new ExceptionalUnitGraph(stores.remove("<toy_benchmark.Test2: int main2(int)>"));
